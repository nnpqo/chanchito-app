...
export default function LandingPage({ onUserLogin, onUserRegister, onBusinessRegister }: LandingPageProps) {
  ...
  const companies = [
    { name: "Tigo", logo: "📱", color: "bg-blue-100" },
    { name: "Viva", logo: "🔴", color: "bg-red-100" },
    { name: "Entel", logo: "🟢", color: "bg-green-100" },
    { name: "Banco Sol", logo: "☀️", color: "bg-yellow-100" },
    { name: "BNB", logo: "🏦", color: "bg-blue-100" },
    { name: "Mercantil", logo: "💳", color: "bg-green-100" },
    { name: "Hipermaxi", logo: "🛒", color: "bg-orange-100" },
    { name: "Ketal", logo: "🏪", color: "bg-purple-100" },
    { name: "Farmacorp", logo: "⚕️", color: "bg-green-100" },
    { name: "IC Norte", logo: "🏥", color: "bg-blue-100" },
    { name: "Multicine", logo: "🎬", color: "bg-red-100" },
    { name: "Ventura", logo: "🛍️", color: "bg-pink-100" }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-cyan-50 overflow-hidden">
      ...
      <section className="relative z-10 px-6 py-16">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-12">Más de 200 empresas ofrecen descuentos exclusivos a nuestros ahorradores</p>
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-12 gap-4">
            {companies.map((company, index) => (
              <motion.div
                ...
                className={`${company.color} rounded-2xl p-4 text-center hover:shadow-lg transition-all duration-300`}
              >
          ...
          <motion.button
            ...
            className="mt-8 px-6 py-3 border-2 border-purple-200 text-purple-600 rounded-2xl font-semibold hover:border-purple-300 hover:bg-purple-50 transition-all duration-300"
          >
            Únete como empresa
          </motion.button>
        </div>
